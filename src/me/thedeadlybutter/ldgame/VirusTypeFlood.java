 ...
 * @author Butters
 */
public class VirusTypeFlood extends Virus {

    public VirusTypeFlood(){
        super("PacketFlood", 300);
        try{
            this.setSprite(ImageIO.read(this.getClass().getResource("res/FloodIcon.png")));
    ...
    public void handleSystem(Main game, AntiSystem system, Building building, VirusGun gun) {
        if(system.getName().equalsIgnoreCase("firewall")){
            ...
            if(system.doAction()){
                ...
                building.foundSystemButDidNotDestory(system); //Can't destroy this
                return;
            }
        }
            ...
            building.destroyCurrentSystemAndReplace(); //Only this can handle net monitor
        }
    }
