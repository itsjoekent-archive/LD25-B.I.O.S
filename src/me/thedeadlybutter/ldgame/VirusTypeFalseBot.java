 ...
 * @author Butters
 */
public class VirusTypeFalseBot extends Virus {

    public VirusTypeFalseBot(){
        super("FalseBot", 200);
        try{
            this.setSprite(ImageIO.read(this.getClass().getResource("res/FalseBotIcon.png")));
