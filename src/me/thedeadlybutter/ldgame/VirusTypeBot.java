 ...
 * @author Butters
 */
public class VirusTypeBot extends Virus {
    
    public VirusTypeBot(){
        super("Bot", 50);
        try{
            this.setSprite(ImageIO.read(this.getClass().getResource("res/BotIcon.png")));
    ...
    public void handleSystem(Main game, AntiSystem system, Building building, VirusGun gun) {
        if(system.getName().equalsIgnoreCase("firewall")){
            ...
            if(system.doAction()){
                ...
                building.foundSystemButDidNotDestory(system); //Bot can't destory this
                return;
            }
        }
